...
module.exports = function (_ref, pluginOptions) {
  ...
  var definitions = getDefinitions(markdownAST);
      ...
      return _regenerator.default.wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 22:
            ...
            title = node.title ? _.escape(node.title) : "";
          ...
          case 64:
            ...
            if (imageCaption) {
              rawHTML = ("\n  <figure class=\"gatsby-resp-image-figure\" style=\"" + wrapperStyle + "\">\n    " + rawHTML + "\n    <figcaption class=\"gatsby-resp-image-figcaption\"> <span class=\"gatsby-resp-image-caption\">" + imageCaption + "</span></figcaption>\n  </figure>\n      ").trim();
            }
  ...
  markdownImageNodes.map(function (_ref8) {
    ...
    return new Promise(function (resolve) {
      ...
      var fileType = getImageInfo(node.url).ext;
