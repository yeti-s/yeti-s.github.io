...
<ColorText color='var(--primary)'>Beam search는 항상 최적의 솔루션을 보장하는 것은 아니에요.</ColorText>
하지만 완전 탐색보다는 효율적이죠.
